...
import fr.enchantments.custom.runnables.RunnablePerpetualBlackHole;
...
public class Projectile_BlackHole extends BaseEnchantment implements IZoneEffectEnchantment{
     ...
     */
	public Projectile_BlackHole(String enchantmentName, int enchantmentID, int maxLevel, int weight, boolean isLegit) {
	...
	public void onProjectileHit(ItemStack projectileShooter, Entity projectileEntity, short level) {
		...
		new RunnablePerpetualBlackHole(projectileEntity,level).runTaskTimer(PluginLoader.pluginLoader, 0, 10);
	}
