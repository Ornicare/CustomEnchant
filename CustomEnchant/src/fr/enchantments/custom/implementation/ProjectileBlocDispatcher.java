...
public class ProjectileBlocDispatcher extends CommonEnchantment implements IZoneEffectEnchantment
{

    public ProjectileBlocDispatcher(String enchantmentName, int enchantmentID, int maxLevel) { super(enchantmentName, (short) enchantmentID, (short) maxLevel); }
