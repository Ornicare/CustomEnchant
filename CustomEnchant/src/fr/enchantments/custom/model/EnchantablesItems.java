...
public abstract class EnchantablesItems {
	...
	protected static int[] swords = { Item.WOOD_SWORD.id, Item.STONE_SWORD.id,
			Item.IRON_SWORD.id, Item.DIAMOND_SWORD.id, Item.GOLD_SWORD.id };
	protected static int[] axes = { Item.WOOD_AXE.id, Item.STONE_AXE.id,
			Item.IRON_AXE.id, Item.DIAMOND_AXE.id, Item.GOLD_AXE.id };
	protected static int[] pickaxes = { Item.WOOD_PICKAXE.id, Item.STONE_PICKAXE.id,
			Item.IRON_PICKAXE.id, Item.DIAMOND_PICKAXE.id, Item.GOLD_PICKAXE.id };
	protected static int[] special = { Item.SNOW_BALL.id };
	protected static int[] armors = { Item.LEATHER_BOOTS.id,
	...
	protected static int[] interact = { Item.BOOK.id };
}
